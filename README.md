...
Complete code and instructions to build the app from scratch can be viewed here: https://s3.amazonaws.com/engineereddatasolutions.com/flask-api-demo-jupytor.html
